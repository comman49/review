...
public class CustomerController {
	...
	public String noticeReg(Notice n, MultipartFile file, Principal principal, HttpServletRequest request) throws IOException{
		
	/*	request로 가져와햐 하지만, spring에서 직접 가져오게끔 해줌*/
